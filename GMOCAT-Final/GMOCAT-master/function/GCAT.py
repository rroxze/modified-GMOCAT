...
class ActorCritic(nn.Module):
    ...
    def hidden_layer(self, p_rec, p_target, a_rec, kn_rec, kn_num):# kn_rec (B,L,num_k)
        ...
        # print(f"Raw question embedding: \n{exer_emb}")
        # print(f"Raw concept embedding: \n{kn_emb}")

        # print(f"Raw answer embedding: \n{batch_ans_emb}")
        # print(f"Relation aware question embedding: \n{batch_exer_emb}")
        # print(f"Relation aware concept embedding: \n{batch_kn_emb}")
        if self.args.use_attention:
            # atten
